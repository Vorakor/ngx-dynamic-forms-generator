...
import { NgxDFFieldDefinition, NgxDFFieldGroup, NgxDFConfiguration } from '../interfaces';

@Component({
    // tslint:disable-next-line: component-selector
    selector: 'ngx-dynamic-forms',
    templateUrl: './ngx-dynamic-forms.component.html',
    styleUrls: ['./ngx-dynamic-forms.component.scss'],
})
